<h1 align="center"> Hi there, I'm Sahan 👋 </h1>
...
## 📙 Recent Blog Posts
<!--START_SECTION:feed-->
* [When IMemoryCache Stops Scaling: Moving to Redis with .NET Aspire](https:&#x2F;&#x2F;www.sahansera.dev&#x2F;when-imemorycache-stops-scaling-redis-aspire&#x2F;)
* [Replacing Sharp with WASM: How a Hidden SVG Dependency Broke Our Rendering Pipeline](https:&#x2F;&#x2F;www.sahansera.dev&#x2F;replacing-sharp-with-wasm-hidden-svg-dependency&#x2F;)
* [When Three Kubernetes Pods Try to Run One Database Migration](https:&#x2F;&#x2F;www.sahansera.dev&#x2F;when-three-kubernetes-pods-try-to-run-one-database-migration&#x2F;)
